...
$options2[] = array("id" => "tmpmela_header_bottom_bkg_after_color",
    "label" => "Header Bottom After Background  Color",
    "type" => "textbox-1",
    "std" => "3b3b3b",
    "description" => "Change your header bottom after background color. ");
$options2[] = array("label" => "Header Contact Setting",
    "title" => "Header Contact Setting",
    "type" => "Title-1");
$options2[] = array("id" => "tmpmela_show_header_contact",
    "label" => "Show Header Contact Setting?",
    "type" => "select",
    "description" => "Displays Header Contact Service. ",
    "options" => array('yes' => 'Yes', 'no' => 'No'));
$options2[] = array("id" => "tmpmela_header_contact_text",
    "label" => "Header Contact Text",
    "type" => "textbox",
    "std" => "Support",
    "description" => "Your Header Contact Text. ");
$options2[] = array("id" => "tmpmela_header_contact_number",
    "label" => "Header Contact text Number",
    "type" => "textbox",
    "std" => "1800 5555 3636",
    "description" => "Change your Header Contact Number");
...
$options2[] = array("id" => "tmpmela_navbar_category_title",
    "label" => "Navigation Category Title",
    "type" => "textbox",
    "std" => "All Categories",
    "description" => "Change Sidebar Category Title. ");
$options2[] = array("id" => "tmpmela_navbar_category_title_bkg_color",
    "label" => "Navigation Category Title Background Color",
    "type" => "textbox-1",
    "std" => "All Categories",
    "description" => "Change Sidebar Category Title Background Color. ");
$options2[] = array("id" => "tmpmela_category_title_text_color",
...
$options6[] = array("id" => "tmpmela_show_offer_text",
					"label" => "Offer Text",
					"type" => "textbox",
					"std" => "Welcome To Worldwide expend Store",
...
<div class="main-block">
        ...
        <div class="wrap">
            ...
            <div class="tmpmela_contents">
                <div class="entry-content">
                    <p>
                        <a target="_Self" href="#" title="<?php esc_attr_e('Templatemela', 'expend'); ?>">TemplateMela</a> <br/>
    ...
    <div id="tab-container" class='tab-container'>
        <ul class='etabs'>
            <li class="tab first">
                <a href="#General" title="<?php esc_html_e('General Settings', 'expend'); ?>">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/general_setting.png" alt="<?php echo esc_attr_e('general', 'expend'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('General', 'expend'); ?>
                    </span>
                </a>
            </li>
            <li class="tab header">
                <a href="#Header">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/header_setting.png" alt="<?php echo esc_attr_e('header', 'expend'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('Header', 'expend'); ?>
                    </span>
                </a>
            </li>
			 <li class="tab topbar"> <a href="#Topbar"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/topbar_setting.png" alt="<?php echo esc_html_e('Topbar','expend'); ?>"/> <span class="title">
      <?php echo esc_html__('Topbar','expend');?>
      </span></a> </li>
            <li class="tab">
                <a href="#Content">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/content_settings.png" alt="<?php echo esc_attr_e('content', 'expend'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('Content', 'expend'); ?>
                    </span>
                </a>
            </li>
            <li class="tab">
                <a href="#Footer">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/footer_settings.png" alt="<?php echo esc_attr_e('footer', 'expend'); ?>"/>
                    <span class="title">
                        <?php echo esc_attr_e('Footer', 'expend'); ?>
                    </span>
                </a>
            </li>
            <?php if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) : ?>
                <li class="tab">
                    <a href="#product">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/megnor/admin/product_setting.png"  alt="<?php echo esc_attr_e('product', 'expend'); ?>"/>
                        <span class="title">
                            <?php echo esc_attr_e('Product', 'expend'); ?>
                        </span>
                    </a>
                </li>
            <?php endif; ?>
    ...
    ?>
        ...
        <div class="background-title">
          <label>
          <?php echo esc_html__('Topbar Settings', 'expend'); ?>
          </label>
        </div>
        <?php
     foreach ($options6 as $value) { 
                ...
                <div id="Header">
                    <form enctype="multipart/form-data" method="post" id="settingForm2" name="settingForm2">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_html__('Header Settings', 'expend'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options2
                ...
                <div id="Content">
                    <form enctype="multipart/form-data" method="post" id="settingForm3" name="settingForm3">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_attr_e('Content Settings', 'expend'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options3
                ...
                <div id="Footer">
                    <form enctype="multipart/form-data" method="post" id="settingForm4" name="settingForm4">
                        ...
                        <div class="form-table">
                            <div class="background-title">
                                <label>
                                    <?php echo esc_html__('Footer Settings', 'expend'); ?>
                                </label>
                            </div>
                            <?php
                            foreach ($options4
